---
  Technical SEO for public marketing surfaces: sales page, docs, and embed widgets that drive organic discovery for Quantyra GeoIDX
...
curl -s https://idx.quantyralabs.cc/ | grep -i "<title>"

# Test structured data (after deployment)
# Use Google's Rich Results Test on public URLs