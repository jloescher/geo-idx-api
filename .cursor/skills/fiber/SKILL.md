...
description: |
  ...
  Use when: implementing or refactoring Fiber work, troubleshooting routes, services, database, or aligning new changes with the repository's existing conventions
