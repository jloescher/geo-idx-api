...
description: |
  ...
  Use when: implementing or refactoring Prioritizing Roadmap Bets work, troubleshooting activation onboarding, engagement adoption, in app guidance, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Prioritizing Roadmap Bets Skill

This fallback skill keeps Prioritizing Roadmap Bets work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.

## Before You Code (REQUIRED)

This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving prioritizing-roadmap-bets, verify against current docs FIRST:
...
```sh
rg -n "prioritizing-roadmap-bets|activation-onboarding|engagement-adoption|in-app-guidance" .
rg --files | rg "prioritizing-roadmap-bets|activation-onboarding|engagement-adoption"
```
...
**When:** The task touches activation onboarding in Prioritizing Roadmap Bets work.
...
**When:** The task touches engagement adoption in Prioritizing Roadmap Bets work.
...
**When:** The task touches in app guidance in Prioritizing Roadmap Bets work.
