# Mapping User Journeys Activation Onboarding Reference

## When To Use

Use this reference when the task touches activation onboarding while working on Mapping User Journeys code in this repository.
