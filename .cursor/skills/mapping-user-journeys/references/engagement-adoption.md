# Mapping User Journeys Engagement Adoption Reference

## When To Use

Use this reference when the task touches engagement adoption while working on Mapping User Journeys code in this repository.
