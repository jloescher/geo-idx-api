# Mapping User Journeys Product Analytics Reference

## When To Use

Use this reference when the task touches product analytics while working on Mapping User Journeys code in this repository.
