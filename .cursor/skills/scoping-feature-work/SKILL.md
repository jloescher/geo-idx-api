...
description: |
  ...
  Use when: implementing or refactoring Scoping Feature Work work, troubleshooting activation onboarding, engagement adoption, in app guidance, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Scoping Feature Work Skill

This fallback skill keeps Scoping Feature Work work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.
...
```sh
rg -n "scoping-feature-work|activation-onboarding|engagement-adoption|in-app-guidance" .
rg --files | rg "scoping-feature-work|activation-onboarding|engagement-adoption"
```
...
**When:** The task touches activation onboarding in Scoping Feature Work work.
...
**When:** The task touches engagement adoption in Scoping Feature Work work.
...
**When:** The task touches in app guidance in Scoping Feature Work work.
