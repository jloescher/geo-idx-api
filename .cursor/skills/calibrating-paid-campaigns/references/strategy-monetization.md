# Calibrating Paid Campaigns Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Calibrating Paid Campaigns code in this repository.
