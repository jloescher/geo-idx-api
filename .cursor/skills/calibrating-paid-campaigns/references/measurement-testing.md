# Calibrating Paid Campaigns Measurement Testing Reference

## When To Use

Use this reference when the task touches measurement testing while working on Calibrating Paid Campaigns code in this repository.
