# Calibrating Paid Campaigns Content Copy Reference

## When To Use

Use this reference when the task touches content copy while working on Calibrating Paid Campaigns code in this repository.
