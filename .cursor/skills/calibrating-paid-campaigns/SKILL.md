...
description: |
  ...
  Use when: implementing or refactoring Calibrating Paid Campaigns work, troubleshooting conversion optimization, content copy, distribution, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Calibrating Paid Campaigns Skill

This fallback skill keeps Calibrating Paid Campaigns work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.

## Before You Code (REQUIRED)

This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving calibrating-paid-campaigns, verify against current docs FIRST:
...
```sh
rg -n "calibrating-paid-campaigns|conversion-optimization|content-copy|distribution" .
rg --files | rg "calibrating-paid-campaigns|conversion-optimization|content-copy"
```
...
**When:** The task touches conversion optimization in Calibrating Paid Campaigns work.
...
**When:** The task touches content copy in Calibrating Paid Campaigns work.
...
**When:** The task touches distribution in Calibrating Paid Campaigns work.
