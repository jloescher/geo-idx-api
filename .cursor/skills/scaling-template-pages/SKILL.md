...
This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving scaling-template-pages, verify against current docs FIRST:
