# Scaling Template Pages Competitive Reference

## When To Use

Use this reference when the task touches competitive while working on Scaling Template Pages code in this repository.
