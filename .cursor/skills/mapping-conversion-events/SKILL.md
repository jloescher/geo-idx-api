...
description: |
  ...
  Use when: implementing or refactoring Mapping Conversion Events work, troubleshooting conversion optimization, content copy, distribution, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Mapping Conversion Events Skill

This fallback skill keeps Mapping Conversion Events work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.

## Before You Code (REQUIRED)

This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving mapping-conversion-events, verify against current docs FIRST:
...
```sh
rg -n "mapping-conversion-events|conversion-optimization|content-copy|distribution" .
rg --files | rg "mapping-conversion-events|conversion-optimization|content-copy"
```
...
**When:** The task touches conversion optimization in Mapping Conversion Events work.
...
**When:** The task touches content copy in Mapping Conversion Events work.
...
**When:** The task touches distribution in Mapping Conversion Events work.
