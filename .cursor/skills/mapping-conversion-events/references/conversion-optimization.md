# Mapping Conversion Events Conversion Optimization Reference

## When To Use

Use this reference when the task touches conversion optimization while working on Mapping Conversion Events code in this repository.
