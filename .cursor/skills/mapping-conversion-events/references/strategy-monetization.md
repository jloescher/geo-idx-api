# Mapping Conversion Events Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Mapping Conversion Events code in this repository.
