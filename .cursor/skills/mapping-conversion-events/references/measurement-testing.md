# Mapping Conversion Events Measurement Testing Reference

## When To Use

Use this reference when the task touches measurement testing while working on Mapping Conversion Events code in this repository.
