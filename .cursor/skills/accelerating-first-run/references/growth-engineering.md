# Accelerating First Run Growth Engineering Reference

## When To Use

Use this reference when the task touches growth engineering while working on Accelerating First Run code in this repository.
