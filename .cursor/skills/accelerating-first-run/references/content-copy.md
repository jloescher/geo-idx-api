# Accelerating First Run Content Copy Reference

## When To Use

Use this reference when the task touches content copy while working on Accelerating First Run code in this repository.
