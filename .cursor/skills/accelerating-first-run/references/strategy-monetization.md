# Accelerating First Run Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Accelerating First Run code in this repository.
