# Accelerating First Run Distribution Reference

## When To Use

Use this reference when the task touches distribution while working on Accelerating First Run code in this repository.
