...
name: livewire
description: |
  Manages Livewire 3 reactive components and Blade integration.
  Use when: implementing or refactoring Livewire work, troubleshooting patterns, workflows, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Livewire Skill

This fallback skill keeps Livewire work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.
...
```sh
rg -n "livewire|patterns|workflows" .
rg --files | rg "livewire|patterns|workflows"
```
...
**When:** The task touches patterns in Livewire work.
...
**When:** The task touches workflows in Livewire work.
