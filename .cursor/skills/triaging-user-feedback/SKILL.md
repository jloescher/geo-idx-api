...
description: |
  ...
  Use when: implementing or refactoring Triaging User Feedback work, troubleshooting activation onboarding, engagement adoption, in app guidance, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Triaging User Feedback Skill

This fallback skill keeps Triaging User Feedback work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.
...
```sh
rg -n "triaging-user-feedback|activation-onboarding|engagement-adoption|in-app-guidance" .
rg --files | rg "triaging-user-feedback|activation-onboarding|engagement-adoption"
```
...
**When:** The task touches activation onboarding in Triaging User Feedback work.
...
**When:** The task touches engagement adoption in Triaging User Feedback work.
...
**When:** The task touches in app guidance in Triaging User Feedback work.
