...
description: |
  ...
  Use when: implementing or refactoring Designing Variation Tests work, troubleshooting conversion optimization, content copy, distribution, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Designing Variation Tests Skill

This fallback skill keeps Designing Variation Tests work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.

## Before You Code (REQUIRED)

This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving designing-variation-tests, verify against current docs FIRST:
...
```sh
rg -n "designing-variation-tests|conversion-optimization|content-copy|distribution" .
rg --files | rg "designing-variation-tests|conversion-optimization|content-copy"
```
...
**When:** The task touches conversion optimization in Designing Variation Tests work.
...
**When:** The task touches content copy in Designing Variation Tests work.
...
**When:** The task touches distribution in Designing Variation Tests work.
