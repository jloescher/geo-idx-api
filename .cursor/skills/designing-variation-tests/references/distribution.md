# Designing Variation Tests Distribution Reference

## When To Use

Use this reference when the task touches distribution while working on Designing Variation Tests code in this repository.
