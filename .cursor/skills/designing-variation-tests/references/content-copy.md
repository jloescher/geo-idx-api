# Designing Variation Tests Content Copy Reference

## When To Use

Use this reference when the task touches content copy while working on Designing Variation Tests code in this repository.
