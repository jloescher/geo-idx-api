# Designing Variation Tests Conversion Optimization Reference

## When To Use

Use this reference when the task touches conversion optimization while working on Designing Variation Tests code in this repository.
