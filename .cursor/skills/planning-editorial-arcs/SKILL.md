...
description: |
  ...
  Use when: implementing or refactoring Planning Editorial Arcs work, troubleshooting conversion optimization, content copy, distribution, or aligning new changes with the repository's existing conventions
allowed-tools: Read, Edit, Write, Glob, Grep, Bash
---

# Planning Editorial Arcs Skill

This fallback skill keeps Planning Editorial Arcs work aligned with the conventions already present in this repository. Prefer extending the closest existing implementation over inventing a new abstraction, and verify neighboring states before finishing.

## Before You Code (REQUIRED)

This skill's content was captured at generation time and MAY be stale. For ANY non-trivial change involving planning-editorial-arcs, verify against current docs FIRST:
...
```sh
rg -n "planning-editorial-arcs|conversion-optimization|content-copy|distribution" .
rg --files | rg "planning-editorial-arcs|conversion-optimization|content-copy"
```
...
**When:** The task touches conversion optimization in Planning Editorial Arcs work.
...
**When:** The task touches content copy in Planning Editorial Arcs work.
...
**When:** The task touches distribution in Planning Editorial Arcs work.
