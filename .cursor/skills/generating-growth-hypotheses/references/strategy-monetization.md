# Generating Growth Hypotheses Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Generating Growth Hypotheses code in this repository.
