# Generating Growth Hypotheses Distribution Reference

## When To Use

Use this reference when the task touches distribution while working on Generating Growth Hypotheses code in this repository.
