# Generating Growth Hypotheses Content Copy Reference

## When To Use

Use this reference when the task touches content copy while working on Generating Growth Hypotheses code in this repository.
