...
This directory holds **in-repo** Cursor agent skills (each subfolder contains its own `SKILL.md`). Growth-only marketing skills were removed; use the table below for this codebase.
