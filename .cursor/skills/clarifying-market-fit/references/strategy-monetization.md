# Clarifying Market Fit Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Clarifying Market Fit code in this repository.
