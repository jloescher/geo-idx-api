# Adding Structured Signals Content Reference

## When To Use

Use this reference when the task touches content while working on Adding Structured Signals code in this repository.
