# Adding Structured Signals Competitive Reference

## When To Use

Use this reference when the task touches competitive while working on Adding Structured Signals code in this repository.
