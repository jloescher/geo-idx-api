# Adding Structured Signals Technical Reference

## When To Use

Use this reference when the task touches technical while working on Adding Structured Signals code in this repository.
