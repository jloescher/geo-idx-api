# Adding Structured Signals Schema Reference

## When To Use

Use this reference when the task touches schema while working on Adding Structured Signals code in this repository.
