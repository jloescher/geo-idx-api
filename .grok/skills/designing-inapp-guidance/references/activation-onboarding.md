# Designing Inapp Guidance Activation Onboarding Reference

## When To Use

Use this reference when the task touches activation onboarding while working on Designing Inapp Guidance code in this repository.
