# Clarifying Market Fit Distribution Reference

## When To Use

Use this reference when the task touches distribution while working on Clarifying Market Fit code in this repository.
