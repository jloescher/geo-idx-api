# Scaling Template Pages Schema Reference

## When To Use

Use this reference when the task touches schema while working on Scaling Template Pages code in this repository.
