# Accelerating First Run Measurement Testing Reference

## When To Use

Use this reference when the task touches measurement testing while working on Accelerating First Run code in this repository.
