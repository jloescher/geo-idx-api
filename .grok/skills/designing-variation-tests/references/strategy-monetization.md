# Designing Variation Tests Strategy Monetization Reference

## When To Use

Use this reference when the task touches strategy monetization while working on Designing Variation Tests code in this repository.
