# Adding Structured Signals On Page Reference

## When To Use

Use this reference when the task touches on page while working on Adding Structured Signals code in this repository.
