# Adding Structured Signals Programmatic Reference

## When To Use

Use this reference when the task touches programmatic while working on Adding Structured Signals code in this repository.
