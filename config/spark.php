...
return [
    ...
    */
    ...
    'sync_replication_top' => min(1000, max(1, (int) env('MLS_BEACHES_REPLICATION_TOP', env('SPARK_SYNC_REPLICATION_TOP', 1000)))),

    'sync_incremental_top' => min(1000, max(1, (int) env('MLS_BEACHES_INCREMENTAL_TOP', env('SPARK_SYNC_INCREMENTAL_TOP', 1000)))),
    ...
    'sync_max_requests_per_second' => min(10, max(1, (int) env('MLS_BEACHES_RATE_LIMIT_RPS', env('SPARK_SYNC_MAX_REQUESTS_PER_SECOND', 2)))),
    ...
    'sync_upsert_chunk_size' => min(500, max(25, (int) env('MLS_BEACHES_UPSERT_CHUNK_SIZE', env('SPARK_SYNC_UPSERT_CHUNK', 250)))),

    'sync_persist_job_chunk_size' => min(250, max(25, (int) env('MLS_BEACHES_PERSIST_CHUNK_SIZE', env('SPARK_SYNC_PERSIST_JOB_CHUNK', 25)))),
