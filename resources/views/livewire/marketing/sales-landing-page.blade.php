...
new class extends Component {
    ...
    public array $geographyHighlights = [
        ['title' => 'Boundary-aware search', 'description' => 'Let buyers explore by neighborhoods, service areas, and local boundaries that match how they actually shop.'],
        ['title' => 'Map-first relevance', 'description' => 'Prioritize discovery by location context so lead intent is clearer before a form submission.'],
        ['title' => 'Local funnel precision', 'description' => 'Keep campaigns aligned to the exact geographies your team serves instead of broad generic pages.'],
    ];
    /** @var array<int, array<string, string>> */
    public array $marketIntelHighlights = [
        ['title' => 'Context-rich listing experiences', 'description' => 'Layer market signals into discovery surfaces so buyers understand the story behind price movement.'],
        ['title' => 'Portfolio-ready insights', 'description' => 'Support investor-focused funnels with digestible market-intelligence overlays for faster qualification.'],
        ['title' => 'Future-ready intelligence stack', 'description' => 'Designed to expand with additional market overlays, including digital-asset-aware trend context.'],
    ];
    /** @var array<int, array<string, string>> */
    ...
    public array $comparisonRows = [
        ['category' => 'Best for', 'pro' => 'Solo GHL operators', 'smart' => 'Teams running multiple funnels'],
        ...
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid gap-6 lg:grid-cols-2">
                <div class="rounded-2xl border border-white/10 bg-slate-900/60 p-5">
                    ...
                    ><code>&lt;script
  src="{{ rtrim(config('app.url'), '/') }}/widget/loader.js?token=YOUR_SITE_KEY&amp;primaryColor=3b82f6&amp;accentColor=10b981"
  data-widget="search"
