...
<div class="rounded-2xl border border-white/10 bg-slate-900/60 p-4">
    ...
    <form wire:submit="saveSearch" class="mt-3 grid gap-2 md:grid-cols-3">
        <input type="text" wire:model="name" placeholder="Search name" class="rounded-lg border border-white/15 bg-slate-950/70 px-3 py-2 text-xs text-slate-100 md:col-span-2">
        <select wire:model="status" class="rounded-lg border border-white/15 bg-slate-950/70 px-3 py-2 text-xs text-slate-100">
        ...
        <button type="submit" class="rounded-lg bg-cyan-500 px-3 py-2 text-xs font-semibold text-slate-950 hover:bg-cyan-400 md:col-span-3">+ New Custom Search</button>
    </form>
