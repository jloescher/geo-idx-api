@if ($activePanel === 'dashboard')
    ...
    <section class="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <article class="idx-metric-card transition hover:-translate-y-0.5">
            <p class="text-xs font-semibold uppercase tracking-wide text-slate-300">Verified domains</p>
            ...
            <a wire:navigate href="{{ \App\Support\DashboardUrl::panel('domains') }}" class="mt-1 inline-flex text-sm font-medium text-cyan-200 hover:text-cyan-100">Manage domains</a>
        </article>
        <article class="idx-metric-card transition hover:-translate-y-0.5">
            <p class="text-xs font-semibold uppercase tracking-wide text-slate-300">Bearer + domain</p>
        ...
        <article class="idx-metric-card transition hover:-translate-y-0.5">
            <p class="text-xs font-semibold uppercase tracking-wide text-slate-300">API tokens</p>
            ...
            <a wire:navigate href="{{ \App\Support\DashboardUrl::panel('api') }}" class="mt-1 inline-flex text-sm font-medium text-cyan-200 hover:text-cyan-100">Open API tab</a>
        </article>
    </section>
@endif
