...
<head>
    ...
    <title>Reset password | GeoIDX by Quantyra Labs</title>
    ...
    <div class="relative min-h-screen overflow-hidden">
        ...
        <main class="relative z-10 mx-auto flex min-h-[calc(100vh-4.5rem)] max-w-6xl items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
            <div class="w-full max-w-md rounded-2xl border border-white/10 bg-slate-900/90 p-8 shadow-2xl backdrop-blur">
                <div class="space-y-6">
                    <div>
                        <h2 class="text-xl font-bold tracking-tight text-slate-100">Forgot password</h2>
                    ...
                    <form method="POST" action="{{ route('password.email', [], false) }}" class="space-y-5">
                        ...
                        <div>
                            <label for="forgot-email" class="block text-sm font-medium text-slate-200">Email</label>
                            <input
                                id="forgot-email"
                                name="email"
                                type="email"
